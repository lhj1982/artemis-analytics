...
public class UserIdentifierTest {
    ...
    public void test_identifyWafUser_umid() throws Exception {
        Tuple2<WafUserType, Tuple3<String, String, String>> result = Tuple2.of(WafUserType.umid, Tuple3.of("umid123", AccountType.PLUS.getType(), "bacd8444-6a51-4ea1-9585-691a33173e5d"));
        ...
        Tuple2<WafUserType, Tuple3<String, String, String>> actual = UserIdentifier.identifyWafUser(PATHS, wafData);
        assertEquals(result, actual);
    }

    @Test
    public void test_identifyWafUser_phonenumber1() throws Exception {
        Tuple2<WafUserType, Tuple3<String, String, String>> result = Tuple2.of(WafUserType.phonenumber, Tuple3.of("+8613356789876", AccountType.PLUS.getType(), ""));
        WafData wafData = new WafData();
    ...
    public void test_identifyWafUser_ipaddress1() throws Exception {
        Tuple2<WafUserType, Tuple3<String, String, String>> result = Tuple2.of(WafUserType.ipaddress, Tuple3.of("182.150.27.228", AccountType.PLUS.getType(), ""));
        WafData wafData = new WafData();
        wafData.setRequest_path("/orders/history");
        wafData.setReal_client_ip("182.150.27.228");
        Tuple2<WafUserType, Tuple3<String, String, String>> actual = UserIdentifier.identifyWafUser(PATHS, wafData);

...
public class LaunchRateRuleWindowAssignerTest {
    ...
    public void testLaunchWindowAssigner() {
        LaunchRateRule launchRateRule = new LaunchRateRuleBuilder().blockKind(BlockKind.upmid).limit(10L).windowSize(10L).expiration(30L).ruleState(LaunchRateRule.RuleState.ON).build();

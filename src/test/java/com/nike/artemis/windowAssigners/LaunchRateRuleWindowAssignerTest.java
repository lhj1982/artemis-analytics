...
public class LaunchRateRuleWindowAssignerTest {
    ...
    public void testLaunchWindowAssigner() {
        LaunchRateRule launchRateRule = new LaunchRateRuleBuilder().ruleId("AT-LAUNCH-1").blockKind(BlockKind.county).limit(10L).windowSize(10L).expiration(30L).ruleState(LaunchRateRule.RuleState.ON).build();

...
public class RulesParserTest {
    ...
    public void testParse() {
        ...
        RulesParser rulesParser = new RulesParser(launchTestRulesProvider);
        Tuple2<HashSet<RateRule>, Collection<RuleChange>> rulesAndChanges = rulesParser.getRulesAndChanges(new HashSet<>());
        ...
        assertTrue(rulesAndChanges.f1.contains(new RuleChange(RuleChange.Action.CREATE, rateRule1)));
        assertTrue(rulesAndChanges.f1.contains(new RuleChange(RuleChange.Action.CREATE, rateRule2)));
        assertTrue(rulesAndChanges.f1.contains(new RuleChange(RuleChange.Action.CREATE, rateRule3)));
        ...
        assertTrue(rulesAndChanges.f0.contains(rateRule1));
        assertTrue(rulesAndChanges.f1.contains(new RuleChange(RuleChange.Action.DELETE, rateRule2)));
        assertTrue(rulesAndChanges.f1.contains(new RuleChange(RuleChange.Action.DELETE, rateRule3)));
        ...
        assertEquals(2, rulesAndChanges.f1.size());
        assertTrue(rulesAndChanges.f1.contains(new RuleChange(RuleChange.Action.DELETE, rateRule1)));
        assertTrue(rulesAndChanges.f1.contains(new RuleChange(RuleChange.Action.DELETE, rateRule2)));

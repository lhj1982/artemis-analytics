...
public class LaunchRequestEvent {
    ...
    public static class Builder {
        ...
        public LaunchRequestEvent build() {
            LaunchRequestEvent requestEvent = new LaunchRequestEvent();
    ...
    public boolean equals(Object o) {
        ...
        LaunchRequestEvent that = (LaunchRequestEvent) o;
